...
public abstract class SecurityObject : IDisposable
{
    ...
    /// <inheritdoc/>
    public override int GetHashCode() => CurrentState.GetHashCode();
    ...
    /// </returns>
    public static bool operator ==(SecurityObject? left, SecurityObject? right) => left!.Equals(right);
    ...
    /// </returns>
    public static bool operator !=(SecurityObject? left, SecurityObject? right) => !(left == right);
}
